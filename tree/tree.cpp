...
void RBTree::inorderBST(Node *&ptr, std::vector<int> &order) {
    if (ptr == nullptr)
        return;
    inorderBST(ptr->left, order);
    order.push_back(ptr->data);
    inorderBST(ptr->right, order);
}

std::vector<int> RBTree::inorder() {
    std::vector<int> order;
    inorderBST(root, order);
    return order;
}

std::vector<int> RBTree::preorder() {
    std::vector<int> order;
    preorderBST(root, order);
    return order;
}
...
std::vector<int> RBTree::postorder() {
    std::vector<int> order;
    postorderBST(root, order);
    return order;
}

void RBTree::postorderBST(Node *&ptr, std::vector<int> &order) {
    if(ptr == nullptr)
        return;
    preorderBST(ptr->left, order);
    preorderBST(ptr->right, order);
    order.push_back(ptr->data);
}

void RBTree::preorderBST(Node *&ptr, std::vector<int> &order) {
    if (ptr == nullptr)
        return;
    order.push_back(ptr->data);
    preorderBST(ptr->left, order);
